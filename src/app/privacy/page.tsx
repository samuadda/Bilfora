	...
	return (
		<div className="min-h-screen bg-surface">
			...
			<main className="pt-32 pb-20 px-4 max-w-3xl mx-auto">
				...
				>
					<div className="inline-flex items-center gap-2 rounded-full bg-brand-soft border border-brand-soft-2 px-4 py-2 mb-4">
						<Shield className="h-4 w-4 text-brand" />
						<span className="text-sm font-medium text-brand">الخصوصية</span>
					</div>
					...
					<div className="flex items-start gap-4">
						...
						<div>
							<p className="text-muted-foreground leading-relaxed">
								<strong className="text-foreground">بالعربي الواضح:</strong> أنا صدّيق، مطور مستقل أبني بلفورا لوحدي.
				...
				<div className="space-y-8">
					...
					>
						<div className="flex items-center gap-3 mb-4">
							...
							<h2 className="text-xl font-bold text-foreground">ايش البيانات اللي نجمعها؟</h2>
						</div>
					...
					>
						<div className="flex items-center gap-3 mb-4">
							...
							<h2 className="text-xl font-bold text-foreground">كيف نحمي بياناتك؟</h2>
						</div>
						<ul className="space-y-3 text-muted-foreground">
							<li className="flex items-start gap-2">
					...
					>
						<div className="flex items-center gap-3 mb-4">
							...
							<h2 className="text-xl font-bold text-foreground">تبي تحذف بياناتك؟</h2>
						</div>
						<p className="text-muted-foreground leading-relaxed">
							حقك. راسلني على <a href="mailto:support@bilfora.com" className="text-brand hover:underline">support@bilfora.com</a> وأحذف كل شي خلال 48 ساعة.
