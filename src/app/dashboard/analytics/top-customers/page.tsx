	...
	return (
		<div className="space-y-8 pb-10">
			...
			<div className="flex items-center gap-4">
				...
				<div>
					<h1 className="text-3xl font-bold text-foreground">أفضل العملاء</h1>
					<p className="text-subtle mt-1">ترتيب العملاء حسب الإيرادات والفواتير</p>
				</div>
			</div>
			...
			<div className="bg-surface rounded-3xl border border-border shadow-sm p-6">
				<div className="relative">
					...
					<input
						...
						className="w-full pl-4 pr-12 py-3 rounded-xl border border-border focus:border-brand focus:ring-2 focus:ring-brand-soft-2 transition-all text-sm"
					/>
				</div>
			</div>
				...
				<div className="overflow-x-auto">
					<table className="w-full">
						<thead className="bg-surface-2">
							<tr>
								...
								<th
									className="px-6 py-4 text-center text-xs font-bold text-subtle uppercase tracking-wider cursor-pointer hover:bg-surface-inset transition-colors"
							...
							{filteredAndSorted.map((customer, index) => (
								...
								>
									<td className="px-6 py-4 text-center">
										<span className="font-bold text-disabled">#{index + 1}</span>
									</td>
									<td className="px-6 py-4">
										<div className="flex items-center gap-3">
											...
											<span className="font-bold text-foreground">{customer.clientName}</span>
										</div>
									</td>
									<td className="px-6 py-4">
									...
									<td className="px-6 py-4 text-center">
										<span className="inline-flex items-center justify-center bg-surface-inset text-muted-foreground rounded-lg px-3 py-1 text-sm font-bold">
					...
					{filteredAndSorted.length === 0 && (
						<div className="flex flex-col items-center justify-center py-16 text-center">
							...
							<p className="text-subtle text-sm">حاول تغيير معايير البحث</p>
						</div>
					)}
				</div>
			</div>
